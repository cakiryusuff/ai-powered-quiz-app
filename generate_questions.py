...
class GenerateQuizDeps:
    text: list[Document] = Field("Content of Documents")
    count_of_questions: int = Field("Number of Questions to be generated")

agent = Agent(
    'gpt-4o-mini',
    deps_type=GenerateQuizDeps,
    result_type=Quizzes,
    system_prompt="You are an expert quiz generator. Your task is to read and analyze the given document "
